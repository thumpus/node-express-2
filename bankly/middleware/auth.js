...
/** FIXES BUG #1: This method will allow the user to continue if they're an admin OR the current user. */
...
/** 
 * FIXES BUG #6: Now throws an error when given an invalid token: returns an error if it cannot decode a username from the token
*/
