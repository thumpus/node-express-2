...
/** Register user with data. Returns new user data. */
  ...
  static async get(username) {
    ...
    //FIXES BUG #4: the word 'throw' was missing below, resulting in an empty but valid response instead of an error when attempting
    //to find an error that doesn't exist. 
    if (!user) {
